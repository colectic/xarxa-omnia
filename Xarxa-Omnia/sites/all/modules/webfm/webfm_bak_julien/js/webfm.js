/* $Id: webfm.js,v 1.47 2011/01/16 01:45:08 nielshackius Exp $ */
...
// SI AFEGEIXES UNA COLUMA, FES EL CANVI TAMBE A WEBFM.MODULE, LINIA 1935 i 3112
Webfm.js_msg = [];
...
//Webfm.js_msg.column5 = Drupal.t("Category");
...
// aqui es per crear el labrel dels imputs del pop-up d'un document
Webfm.meta_msg = [];
...
//Webfm.meta_msg.cat = Drupal.t("category");
...
Webfm.commonInterface = function (parent) {
  ...
  Webfm.metadataHT.put('l', new Webfm.metaElement(Webfm.meta_msg.lang, false, 0));
  //Webfm.metadataHT.put('p', new Webfm.metaElement(Webfm.meta_msg.pub, true, 255));
  Webfm.metadataHT.put('p', new Webfm.metaElement(Webfm.meta_msg.pub, false, 1));
  //Webfm.metadataHT.put('k', new Webfm.metaElement(Webfm.meta_msg.cat, true, 255));
  Webfm.metadataHT.put('k', new Webfm.metaElement(Webfm.meta_msg.cat, false, 1));
  //Webfm.metadataHT.put('f', new Webfm.metaElement(Webfm.meta_msg.format, true, 255));
  Webfm.metadataHT.put('f', new Webfm.metaElement(Webfm.meta_msg.format, false, 1));
...
Webfm.jsUpload.prototype.onsubmit = function() {
  var hide;
  Webfm.progressObj.show(Webfm.js_msg.work,  "red");
  hide = this.hide;
  $(hide).fadeOut('slow');
};
...
Webfm.list = function (parent, id, type, class_name, dd_enable, dir_menu, file_menu) {
  ...
  //if(Webfm.options.displayColumns.category) {Webfm.numColumns++; }
  ...
  // category column
  /*if(Webfm.options.displayColumns.category) {
    elTd = Webfm.ce('td');
    if(Webfm.numColumns < 2) {elTd.colSpan = 2;}
    elTd.className = 'head';
    elA = Webfm.ce('a');
    elA.setAttribute('href', '#');
    // veure linia 1212
    listener = Webfm.eventListenerAdd(Webfm.eventListeners, elA, "click", function(e) { wl.sc_s ^= 1; wl.loadList("k"); wl.sortIcon(e, wl.sc_s); Webfm.stopEvent(e); });

    elImg = Webfm.ce('img');
    elImg.setAttribute('alt', Webfm.js_msg.sort);
    elImg.setAttribute('src', this.iconDir + '/down.gif');
    elA.appendChild(elImg);
    elA.appendChild(Webfm.ctn(Webfm.js_msg.column5));
    elTd.appendChild(elA);
    elTr.appendChild(elTd);
  }*/
  // end category column
...
Webfm.metadata.prototype.buildFormControls = function() {
  ...
  submitButton.setAttribute('type', 'button');
  submitButton.setAttribute('value', Webfm.js_msg.submit);
  submitButton.className = "meta-button_submit";
  ...
  resetButton.setAttribute('type', 'button');
  resetButton.setAttribute('value', Webfm.js_msg.reset);
  resetButton.className = "meta-button_reset";
  listener = Webfm.eventListenerAdd(cp.eventListeners, resetButton, "click", function(e) { cp.createForm(cp.data); Webfm.stopEvent(e); });
  this.controls.appendChild(resetButton);
};
