...
<div id="search">
  <div id="search-input">
 <label for="search_theme_form"></label>
    <input type="text" maxlength="128" name="search_theme_form" id="search_theme_form" size="15" title="<?php print $search_phrase; ?>" value="<?php print $search_label; ?>" onblur="<?php print $on_blur; ?>" onfocus="<?php print $on_focus; ?>" class="form-text" accesskey="b" tabindex="7" />
  </div>
